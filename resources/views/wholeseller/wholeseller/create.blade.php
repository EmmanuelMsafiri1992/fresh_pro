...
<form class="form-horizontal" action="{{ route('superadmins.wholesellers.store') }}" method="post" enctype="multipart/form-data">
@csrf
<div class="card-body">
<div class="row">
<div class="col-md-6 form-group">
<label for="name" class="col-form-label">{{ __('Wholeseller Name') }}<span class="required-field">*</span></label>
<input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" placeholder="{{ __('Wholeseller Name') }}" value="{{ old('name') }}">
@error('name')
