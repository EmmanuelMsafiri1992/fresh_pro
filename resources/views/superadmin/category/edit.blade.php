...
<form class="form-horizontal" action="{{ route('superadmins.categories.update', $category->slug) }}" method="post" enctype="multipart/form-data">
@csrf
@method('PUT')
<div class="card-body">
<div class="row">
...
<input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" placeholder="{{ __('Category Name') }}" value="{{ $category->name }}">
@error('name')
