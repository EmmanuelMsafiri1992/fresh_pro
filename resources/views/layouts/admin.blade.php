...
<head>
    ...
    <meta name="description"
        content="{{ __('myShop is a myShop build to simplify production or manufacturing process. myShop is lightweight, secure and fast and based on laravel.') }}">
    <meta name="keywords"
        content="{{ __('myShop, myShop, Manufacturing system, Inventory system, Stock management, Workshop management, Row material management, Garments System, Food and Beverage, Furniture Companies') }}">
