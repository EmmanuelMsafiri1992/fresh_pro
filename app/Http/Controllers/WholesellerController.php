...
//return view('wholeseller.dashboard');
        ...
        return view('wholeseller.dashboard', compact('stats',  'purchasesChart', 'finishedQtyChart', 'transferredQtyChart', 'expenseChart'));
    }
    //Return setup page
    ...
    public function generalSettings()
    {
        ...
        return view('wholeseller.setup.general', compact('settings'));
    }
