            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item">
                        <a href="{{ route('wholeseller.dashboard') }}">{{ __('Dashboard') }}</a>
                    </li>
                    <li class="breadcrumb-item">
                        <a href="{{ route('wholeseller.setup') }}">{{ __('Setup') }}</a>
                    </li>
        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-tools">
                    <a href="{{ route('wholeseller.setup') }}" class="btn btn-block btn-primary">
            ...
            <div class="card-body p-0">
                <form class="form-horizontal" action="{{ route('wholeseller.setup.general.update') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        <div class="row">
