...
<head>
    <meta charset="utf-8">
    <meta name="description" content="{{ __('myShop is a myShop build to simplify production or manufacturing process. myShop is lightweight, secure and fast and based on laravel.') }}">
    <meta name="keywords" content="{{ __('myShop, myShop, Manufacturing system, Inventory system, Stock management, Workshop management, Row material management, Garments System, Food and Beverage, Furniture Companies') }}">
            ...
            <section class="hero text-center">
                <div class="container-sm">
                    <div class="hero-inner main-logo">
                        <img src="{{ asset('img/logo-black.svg') }}" alt="{{ __('myShop::myShop') }}">
                        <p class="hero-paragraph is-revealing">{{ __('myShop is a myShop build to simplify production or manufacturing process. myShop is lightweight, secure and fast and based on laravel.') }}</p>
                        <div class="hero-form newsletter-form field field-grouped is-revealing">
                            <div class="control demo-btn">
                                <a class="button button-primary button-block button-shadow" href="https://codecanyon.net/item/myShopproduction-management-system/26526177" target="__blank">Buy Now</a>
                                <a class="button button-primary button-block button-shadow mr-3" href="https://myShop.Riverine.net/login" target="__blank">Check Demo</a>
                            </div>
                        </div>
                ...
                <div class="container-sm">
                    <div class="newsletter-inner section-inner">
                        <div class="newsletter-header text-center is-revealing">
                            ...
                            <p class="section-paragraph">We are available for freelance work. If you have any questions that are beyond the scope of this help file, please feel free to inform us to contact us via this mail <a href="mailto:">support@Riverine.net</a>.</p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <div class="container">
                <div class="site-footer-inner">
                    ...
                    <ul class="footer-links list-reset">
                        <li>
                            <a href="https://Riverine.net/about-us" target="__blank">About us</a>
                        </li>
                        <li>
                            <a href="https://Riverine.net/contact-us" target="__blank">Contact</a>
                        </li>
                        <li>
                            <a href="https://Riverine.net/portfolios" target="__blank">Projects</a>
                        </li>
                    </ul>
                    <ul class="footer-social-links list-reset">
                        <li>
                            <a href="https://www.facebook.com/Riverinebd/" target="__blank">
                        ...
                        <li>
                            <a href="https://twitter.com/Riverinebd"  target="__blank">
                    ...
                    <div class="footer-copyright">&copy; {{ date('Y') }} Riverine, all rights reserved</div>
                </div>
            </div>
        </footer>
    </div>
