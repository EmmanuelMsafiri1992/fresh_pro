...
<div class="col-sm-6">
<h1 class="m-0 text-dark">{{ __('Create Shopkeeper') }}</h1>
</div>
<div class="col-sm-6">
...
<li class="breadcrumb-item active">{{ __('Create Shopkeeper') }}</li>
</ol>
</div>
</div>
</div>
...
<h3 class="card-title">{{ __('Add a new Shopkeeper') }}</h3>
...
<form class="form-horizontal" action="{{ route('superadmins.shopkeepers.store') }}" method="post" enctype="multipart/form-data">
@csrf
<div class="card-body">
<div class="row">
<div class="col-md-6 form-group">
<label for="name" class="col-form-label">{{ __('Shopkeeper Name') }}<span class="required-field">*</span></label>
<input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" placeholder="{{ __('Shopkeeper Name') }}" value="{{ old('name') }}">
@error('name')
